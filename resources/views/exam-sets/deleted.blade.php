...
@section('content')
    <div class="min-h-screen bg-[#f7f8fc]">
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Manage your deleted exam sets and restore or permanently remove them.
                </p>
            </div>
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 bg-white">
            ...
            {{-- Card Header --}}
            <x-backend.card-header title="Deleted Items" :count="$examSets->total()" singular="deleted exam set"
                plural="deleted exam sets" action="{{ route('exam-sets.deleted') }}"
                placeholder="Search deleted exam sets..." />
                            ...
                            <tr class="transition hover:bg-red-50/30">
                                ...
                                <td class="max-w-md px-5 py-4">
                                    ...
                                    <p class="truncate text-sm text-slate-500">
                                        {{ $examSet->description ?? 'No description available' }}
                                    </p>
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    @if ($examSet->deleted_at)
                                        <div class="flex items-center gap-2 text-sm text-slate-500">

                                            <i class="bi bi-calendar3 text-red-400"></i>

                                            {{ $examSet->deleted_at->format('d M, Y') }}

                                        </div>

                                        <p class="mt-1 text-xs text-slate-400">
                                            {{ $examSet->deleted_at->format('h:i A') }}
                                        </p>
                                    @else
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        {{-- Restore --}}
                                        <form action="{{ route('exam-sets.restore', $examSet->id) }}" method="POST">

                                            @csrf
                                            @method('PATCH')

                                            <button type="submit" title="Restore Exam Set"
                                        ...
                                        {{-- Permanent Delete --}}
                                        <form method="POST" action="{{ route('exam-sets.forceDelete', $examSet->id) }}"
                                            data-item="exam set permanently" class="delete-form">
                            ...
                            <tr>
                                ...
                                <td colspan="6" class="px-5 py-12 text-center">
                                    ...
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm font-medium text-slate-600">
                                            No deleted exam sets found
                                        </p>

                                        <p class="mt-1 text-xs text-slate-400">
                                            Deleted exam sets will appear here.
                                        </p>
                ...
                @forelse ($examSets as $examSet)
                    <div class="p-4">
                        ...
                        <p class="mt-3 text-xs text-slate-400">
                            ...
                            Deleted
                            {{ $examSet->deleted_at?->format('d M, Y h:i A') }}
                        ...
                        <div class="mt-4 flex items-center gap-2 border-t border-slate-100 pt-4">
                            ...
                            {{-- Restore --}}
                            <form action="{{ route('exam-sets.restore', $examSet->id) }}" method="POST" class="flex-1">
                            ...
                            {{-- Permanent Delete --}}
                            <form action="{{ route('exam-sets.forceDelete', $examSet->id) }}" method="POST"
                                data-item="exam set permanently" class="delete-form flex-1">
