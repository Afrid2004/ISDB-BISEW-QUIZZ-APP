...
@section('content')
    <div class="min-h-screen bg-[#f7f8fc]">
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 bg-white">
            ...
            <div class="border-b border-slate-100 px-4 py-4 sm:px-6">
                <div class="flex w-full gap-1 rounded-lg bg-slate-100 p-1 sm:w-fit">
                    ...
                    <button type="button" id="csvTab"
                        class="question-tab inline-flex flex-1 items-center justify-center gap-2 rounded-md bg-white px-5 py-2.5 text-sm font-semibold text-primary shadow-sm transition sm:flex-none cursor-pointer">
                    ...
                    <button type="button" id="manualTab"
                        class="question-tab inline-flex flex-1 items-center justify-center gap-2 rounded-md px-5 py-2.5 text-sm font-semibold text-slate-500 transition hover:text-slate-700 sm:flex-none cursor-pointer">
            ...
            {{-- CSV IMPORT FORM --}}
            {{-- ============================== --}}
            <form action="{{ route('questions.import') }}" method="POST" enctype="multipart/form-data" id="csvSection"
                ...
                <div
                    ...
                    <p class="mx-auto mt-1 max-w-md text-xs leading-5 text-slate-400">
                        Upload a CSV file containing your questions, options, answers and related information.
                    </p>
                    ...
                    <div class="mt-5 flex items-center justify-center gap-2">
                        <label
                            ...
                            <input type="file" name="file" id="csvFileInput" accept=".csv, .xlsx, .xls" class="hidden"
                                required>
                        </label>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs leading-5 text-slate-400">
                                    Download the sample CSV template before importing your questions.
                                </p>
                    ...
                    <div class="rounded-lg border border-slate-200 bg-white p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs leading-5 text-slate-400">
                                    Make sure your CSV file follows the required column structure.
                                </p>
                                <button type="button" id="viewFormatBtn"
                                    class="mt-3 inline-flex items-center gap-1.5 text-xs font-semibold text-primary hover:underline">
                                    View Format
                ...
                <div class="mt-6 flex justify-end border-t border-slate-100 pt-5">
                    <button type="submit"
                        class="inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-primary/90 cursor-pointer">
            ...
            {{-- MANUAL ADD FORM --}}
            {{-- ============================== --}}
            <form action="{{ route('questions.store') }}" method="POST" id="manualSection"
                ...
                <div class="mt-8 flex flex-col-reverse gap-3 border-t border-slate-100 pt-5 sm:flex-row sm:justify-end">
                    ...
                    <button type="submit"
                        class="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/20 cursor-pointer">
