        ...
        <div class="flex flex-wrap items-center justify-between gap-3 sm:flex-nowrap">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Update the information of this element.
                </p>
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 bg-white">
            ...
            <div class="border-b border-slate-100 px-5 py-4 sm:px-6">
                ...
                <p class="mt-1 text-xs text-slate-400">
                    Update the basic information for this element.
                </p>
            ...
            {{-- Form --}}
            <form
                action="{{ route('elements.update', $element) }}"
                method="POST"
...
@push('scripts') <script src="{{ asset('/assets/js/elements.js') }}"></script>
@endpush
