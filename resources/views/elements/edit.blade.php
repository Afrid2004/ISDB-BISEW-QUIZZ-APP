            ...
            <div class="flex items-center flex-wrap sm:flex-nowrap justify-between gap-3">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Update the information of this competency unit.
                    </p>
                </div>
            ...
            <div class="overflow-hidden rounded-xl border border-slate-200 bg-white">
                ...
                <div class="border-b border-slate-100 px-5 py-4 sm:px-6">
                    ...
                    <p class="mt-1 text-xs text-slate-400">
                        Update the information for this competency unit.
                    </p>
                ...
                {{-- Form --}}
                <form action="{{ route('competency-units.update', $competencyUnit) }}" class="px-5 py-6 sm:px-6"
                    method="POST">
