    ...
    <div class="min-h-screen bg-[#f7f8fc]">
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    View competency unit information and details.
                </p>
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 bg-white">
            ...
            <div class="flex items-center justify-between border-b border-slate-100 px-5 py-4 sm:px-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-xs text-slate-400">
                            Details of this competency unit.
                        </p>
                ...
                @else
                    <span
                        class="inline-flex items-center gap-1.5 rounded-full bg-amber-50 px-3 py-1.5 text-xs font-semibold text-amber-600">
            ...
            <div class="divide-y divide-slate-100">
                ...
                <div class="px-5 py-5 sm:px-6">
                    ...
                    @if ($competencyUnit->module)
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            @if ($competencyUnit->module->course && $competencyUnit->module->course->code)
                                <span
                ...
                <div class="px-5 py-5 sm:px-6">
                    ...
                    @if ($competencyUnit->module && $competencyUnit->module->course)
                        <div class="flex flex-wrap items-center gap-2">
                ...
                <div class="flex flex-col gap-2 px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                    ...
                    <div class="flex items-center gap-2 text-sm text-slate-600">
                        ...
                        @if ($competencyUnit->created_at)
                            {{ $competencyUnit->created_at->format('d M, Y') }}

                            <span class="text-slate-300">•</span>

                            {{ $competencyUnit->created_at->format('h:i A') }}
                        @else
                            N/A
                        @endif
                ...
                <div class="flex flex-col gap-2 px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                    ...
                    <div class="flex items-center gap-2 text-sm text-slate-600">
                        ...
                        @if ($competencyUnit->updated_at)
                            {{ $competencyUnit->updated_at->format('d M, Y') }}

                            <span class="text-slate-300">•</span>

                            {{ $competencyUnit->updated_at->format('h:i A') }}
                        @else
                            N/A
                        @endif
            ...
            <div class="flex flex-col-reverse gap-3 border-t border-slate-100 px-5 py-4 sm:flex-row sm:justify-end sm:px-6">
                ...
                {{-- Delete --}}
                <form data-item="competency unit" action="{{ route('competency-units.destroy', $competencyUnit) }}"
                    ...
                    <button type="submit"
                        class="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-red-200 bg-white px-4 py-2.5 text-sm font-semibold text-red-500 transition hover:bg-red-50 sm:w-auto cursor-pointer">
