        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Manage your deleted modules and restore or permanently remove them.
                </p>
            </div>
                            ...
                            <tr class="transition hover:bg-red-50/30">
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    @if ($module->deleted_at)
                                        <div class="flex items-center gap-2 text-sm text-slate-500">
                                            {{ $module->deleted_at->format('d M, Y') }}

                                        </div>

                                        <p class="mt-1 text-xs text-slate-400">

                                            {{ $module->deleted_at->format('h:i A') }}
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        {{-- Restore --}}
                                        <form action="{{ route('modules.restore', $module->id) }}" method="POST">

                                            @csrf
                                            @method('PATCH')

                                            <button type="submit" title="Restore Module"
                                        ...
                                        {{-- Permanent Delete --}}
                                        <form method="POST" action="{{ route('modules.forceDelete', $module->id) }}"
                                            data-item="module permanently" class="delete-form">
                ...
                @forelse ($modules as $module)
                    <div class="p-4">
                        ...
                        <p class="mt-3 text-xs text-slate-400">
                            Deleted
                            {{ $module->deleted_at?->format('d M, Y h:i A') }}
                        ...
                        <div class="mt-4 flex items-center gap-2 border-t border-slate-100 pt-4">
                            ...
                            {{-- Restore --}}
                            <form action="{{ route('modules.restore', $module->id) }}" method="POST" class="flex-1">
                            ...
                            <form action="{{ route('modules.forceDelete', $module->id) }}" method="POST"
                                data-item="module permanently" class="delete-form flex-1">
