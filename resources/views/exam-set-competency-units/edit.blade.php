            ...
            <div class="flex items-center justify-between gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-slate-800">
                        Edit Exam Set Competency Unit
                    </h1>

                    <p class="mt-1 text-sm text-slate-500">
                        Update the competency unit assignment for this exam set.
                    </p>
                </div>
            ...
            <div class="overflow-hidden rounded-xl border border-slate-200 bg-white">
                ...
                <div class="border-b border-slate-100 px-5 py-4 sm:px-6">
                    ...
                    <h2 class="text-base font-semibold text-slate-800">
                        Exam Set Competency Unit Information
                    </h2>

                    <p class="mt-1 text-xs text-slate-400">
                        Update the exam set, competency unit, and question count.
                    </p>
                ...
                {{-- Form --}}
                <form action="{{ route('exam-set-competency-units.update', $examSetCompetencyUnit) }}"
                    data-item="exam set competency unit" class="px-5 py-6 sm:px-6" method="POST">
