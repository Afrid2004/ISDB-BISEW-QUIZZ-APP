...
@section('content')
    <div class="min-h-screen bg-[#f7f8fc]">
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Manage your deleted courses and restore or permanently remove them.
                </p>
            </div>
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 bg-white">
            ...
            {{-- Card Header --}}
            <x-backend.card-header title="Deleted Items" :count="$courses->total()" singular="deleted course" plural="deleted courses"
                action="{{ route('courses.deleted') }}" placeholder="Search deleted courses..." />
                            ...
                            <tr class="transition hover:bg-red-50/30">
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-2 text-sm text-slate-500">
                                        ...
                                        {{ $course->deleted_at?->format('d M, Y') }}
                                    </div>

                                    @if ($course->deleted_at)
                                        <p class="mt-1 text-xs text-slate-400">
                                            {{ $course->deleted_at->format('h:i A') }}
                                        </p>
                                    @endif
                                </td>
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        {{-- Permanent Delete --}}
                                        <form method="POST" action="{{ route('courses.forceDelete', $course->id) }}"
                                            data-item="course permanently" class="delete-form">
                ...
                @forelse ($courses as $course)
                    <div class="p-4">
                        ...
                        <p class="mt-3 text-xs text-slate-400">
                            Deleted
                            {{ $course->deleted_at?->format('d M, Y h:i A') }}
