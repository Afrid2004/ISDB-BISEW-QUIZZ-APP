    ...
    <div class="min-h-screen bg-[#f7f8fc]">
            ...
            <div class="flex items-center flex-wrap sm:flex-nowrap justify-between gap-3">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Create a new exam for a specific course and batch.
                    </p>
                </div>
        ...
        <div class="mx-auto max-w-3xl md:max-w-full">
            ...
            <div class="overflow-hidden rounded-xl border border-slate-200
                ...
                {{-- Form --}}
                <form action="{{ route('exams.store') }}" class="px-5 py-6 sm:px-6" method="POST">
...
@push('scripts')
    <script src="{{ asset('/assets/js/examsDependecyDropdown.js') }}"></script>
@endpush
