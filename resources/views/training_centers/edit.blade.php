...
<div class="min-h-screen bg-[#f7f8fc] px-4 py-6 sm:px-6 lg:px-0">
    ...
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-slate-800">Edit Training Center</h1>
    ...
    <div class="mx-auto max-w-3xl md:max-w-full">
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <form action="{{ route('training-centers.update', $trainingCenter->id) }}" method="POST" class="px-5 py-6 sm:px-6">
                @csrf
                @method('PUT')
                ...
                <div class="mt-8 flex justify-end gap-3 pt-5">
                    ...
                    <button type="submit" class="bg-primary px-5 py-2.5 text-white font-semibold rounded-lg">Update Training Center</button>
                </div>
            </form>
        </div>
    </div>
