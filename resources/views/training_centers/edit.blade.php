            ...
            <div class="flex items-center justify-between gap-3">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Update the details of {{ $trainingCenter->name }}.
                    </p>
            ...
            <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                ...
                <div class="border-b border-slate-100 px-5 py-4 sm:px-6">
                    ...
                    <p class="mt-1 text-xs text-slate-400">
                        Update the basic and structural details for this training center.
                    </p>
                ...
                {{-- Form --}}
                <form action="{{ route('training-centers.update', $trainingCenter->id) }}"
                    method="POST"
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1.5 text-xs text-slate-400">
                                Enter a unique code for this training center (maximum 50 characters).
                            </p>
                        ...
                        <div>
                            ...
                            >{{ old('location', $trainingCenter->location) }}</textarea>
                            ...
                            <label class="flex cursor-pointer items-center justify-between rounded-lg border border-slate-200 bg-slate-50/50 px-4 py-3 transition hover:bg-slate-50">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        value="1"
                                        class="peer sr-only"
                                        {{ old('is_active', $trainingCenter->is_active) ? 'checked' : '' }}
                                    >
