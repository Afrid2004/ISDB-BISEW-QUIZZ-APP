    ...
    <div class="min-h-screen bg-[#f7f8fc] px-4 py-6 sm:px-6 lg:px-0">
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    View training center information and details.
                </p>
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-xs text-slate-400">
                            Details of this training center.
                        </p>
            ...
            <div class="divide-y divide-slate-100">
                ...
                <div class="flex flex-col gap-2 px-5 py-5
                    ...
                    <div class="flex items-center gap-2 text-sm text-slate-600">
                        ...
                        @if ($trainingCenter->created_at)

                            {{ $trainingCenter->created_at->format('d M, Y') }}

                            <span class="text-slate-300">•</span>

                            {{ $trainingCenter->created_at->format('h:i A') }}
                ...
                <div class="flex flex-col gap-2 px-5 py-5
                    ...
                    <div class="flex items-center gap-2 text-sm text-slate-600">
                        ...
                        @if ($trainingCenter->updated_at)

                            {{ $trainingCenter->updated_at->format('d M, Y') }}

                            <span class="text-slate-300">•</span>

                            {{ $trainingCenter->updated_at->format('h:i A') }}
            ...
            <div class="flex flex-col-reverse gap-3
                ...
                {{-- Delete --}}
                <form action="{{ route('training-centers.destroy', $trainingCenter->id) }}"
                    method="POST"
                ...
                {{-- Edit --}}
                <a href="{{ route('training-centers.edit', $trainingCenter->id) }}"
